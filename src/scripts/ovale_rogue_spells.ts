...
export function register() {
    ...
    let desc = "[8.0] Ovale: Rogue spells";
=======
import { OvaleScripts } from "../Scripts";
export function register() {
    let name = "ovale_rogue_spells";
...
# Your autoattacks increase the damage of your next Shuriken Toss or Poisoned Knife by s, stacking up to 272916u times.
  SpellInfo(sharpened_blades_buff channel=-0.001 gcd=0 offgcd=1)
