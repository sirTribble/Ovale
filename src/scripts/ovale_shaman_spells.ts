...
# Instantly shocks the target with concussive force, causing (250 of Spell Power) Nature damage.
...
# Harnesses the raw power of the elements, dealing (63 of Spell Power) Elemental damage and increasing your Critical Strike, Haste, or Mastery by 118522s1 for 10 seconds.
...
# Sears the target with fire, causing (35 of Spell Power) Fire damage and then an additional o2 Fire damage over 18 seconds.
...
# Hurls frigid ice at the target, dealing (55.00000000000001 of Spell Power) Frost damage and causing your next n Frost Shocks to deal s3 increased damage.rnrn|cFFFFFFFFGenerates 190493s7 Maelstom.|r
...
# Charge yourself with lightning, causing your next n Lightning Bolts or Chain Lightnings to be instant cast and trigger an Elemental Overload on every target.
  ...
  # Your next Lightning Bolt or Chain Lightning is instant and causes Elemental Overload to trigger on every target.
